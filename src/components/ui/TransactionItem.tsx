...
// Helper to assign colors/icons based on category
// You can expand this list as you add more categories
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        {/* 1. CATEGORY AVATAR */}
        <div className={`w-10 h-10 rounded-full flex items-center justify-center text-lg ${style.bg} ${style.text} shadow-sm`}>
            {style.icon}
        </div>
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Delete Button - Standardized Icon */}
        <button 
